...
class TagSingleScreen extends ConsumerWidget {
  const TagSingleScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final tagSelection = ref.watch(singleTagSelectionProvider);
    final tags = ref.watch(tagProvider);

    onTap(TagModel tag) {
      ref.read(singleTagSelectionProvider.notifier).single(tag);
    }
